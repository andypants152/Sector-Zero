...
struct InstructionDecoderTests {
    ...
    @Test("Unrecognised opcodes decode to .unknown carrying the byte", arguments: [
        UInt8(0x60), 0x61, 0x62, 0x64, 0xC0, 0xF3,
    ])
    ...
    func decodingConsumesNoOperandBytes() {
        ...
        // ADC/SBB now fill their r/m↔reg and accumulator-immediate ranges too.
        let operandOpcodes: Set<ClosedRange<UInt8>> = [
            0x00...0x05, 0x08...0x0D, 0x10...0x15, 0x18...0x1D,
            0x20...0x25, 0x28...0x2D, 0x30...0x35, 0x38...0x3D,
            0x70...0x7F, 0x80...0x81, 0x83...0x8F, 0x9A...0x9A, 0xA0...0xA3,
            0xA8...0xA9, 0xB0...0xBF, 0xC2...0xC2, 0xC4...0xC7, 0xCA...0xCA, 0xCD...0xCD, 0xD0...0xD5,
            0xD8...0xDF, 0xE0...0xE7, 0xE8...0xEB, 0xF6...0xF7, 0xFE...0xFF,
        ]
